...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> registerFollower (@RequestBody RegisterRequest registerRequest){
    ...
    @PostMapping("login/follower")
    public ResponseEntity<AuthResponse> loginFollower (@RequestBody LoginRequest loginRequest){
        return ResponseEntity.ok(authService.loginFollower(loginRequest));
    }
